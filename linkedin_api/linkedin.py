...
class Linkedin(object):
    ...
    def get_profile_certifications(self, public_id=None, urn_id=None):
        ...
        res = self._fetch(f"/identity/profiles/{public_id or urn_id}/certifications",
                          params={"count": 100, "start": 0})

        #Play with paging and count when Certifications > 100
        # res_2 = self._fetch(f"/identity/profiles/{public_id or urn_id}/certifications",
        #             params={"count": 100, "start": 100, "paging": 2}).json()
